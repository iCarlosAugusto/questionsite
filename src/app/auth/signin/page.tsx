...
import { ModalPasswordForgotten } from '@/components/ModalPasswordForgotten';
...
const SignIn = () => {
  ...
  return (
    <DefaultLayout showSidebar={false}>
      {isOpen && <ModalPasswordForgotten closeModal={closeModal} isOpen={isOpen} />}
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form action={validateForm}>
                ...
                <ButtonComponent type="submit" label="Entrar" className="w-full mt-5 mb-5" />
